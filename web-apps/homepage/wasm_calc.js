...
function findWasmBinary() {
  return locateFile('wasm_calc.wasm');
}
...
var _compute_fibonacci = Module['_compute_fibonacci'] = makeInvalidEarlyAccess('_compute_fibonacci');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['compute_fibonacci'] != 'undefined', 'missing Wasm export: compute_fibonacci');
  ...
  _compute_fibonacci = Module['_compute_fibonacci'] = createExportWrapper('compute_fibonacci', wasmExports['compute_fibonacci'], 1);
